...
class ISICDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        img_path = os.path.join(self.data_path, "ISBI2016_ISIC_Part3B_Training_Data", f"{name}.jpg")
        
        mask_name = self.label_list[index]
        msk_path = os.path.join(self.data_path, "ISBI2016_ISIC_Part3B_Training_Data", f"{name}_Segmentation.png")
